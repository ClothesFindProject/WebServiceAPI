...
import { CurtidaLojaController } from '../controllers/CurtidaLojaController';
 ...
 */
router.get('/', CurtidaLojaController.list);
 ...
 */
router.get('/:id', CurtidaLojaController.findById);
 ...
 *               $ref: '#/components/schemas/CurtidaLojaResponse'
 */
router.put('/:id', CurtidaLojaController.update);
 ...
 */
router.get('/validarcurtida/:idUsuario/:idEmpresa', CurtidaLojaController.validate);
 ...
 */
router.get('/usuario/:idUsuario', CurtidaLojaController.listEmpresasCurtidas);
 ...
 *               $ref: '#/components/schemas/CurtidaLojaResponse'
 */
router.post('/', CurtidaLojaController.create);
 ...
 *               $ref: '#/components/schemas/MessageResponse'
 */
router.delete('/:id', CurtidaLojaController.remove);
 ...
 *         description: Curtida não encontrada
 */
router.patch('/desativar/:idUsuario/:idEmpresa', CurtidaLojaController.deactivate);

export const curtidaLojaRoutes = router;
