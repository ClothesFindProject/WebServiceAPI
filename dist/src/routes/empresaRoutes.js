 ...
 */
router.get('/', EmpresaController_1.EmpresaController.list);
/**
 * @swagger
 * /api/empresas/{id}:
 *   get:
 ...
 */
router.get('/:id', EmpresaController_1.EmpresaController.findById);
/**
 * @swagger
 * /api/empresas/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/EmpresaResponse'
 */
router.put('/:id', EmpresaController_1.EmpresaController.update);
/**
 * @swagger
 * /api/empresas/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/MessageResponse'
 */
router.delete('/:id', EmpresaController_1.EmpresaController.remove);
/**
 * @swagger
 ...
 */
router.post('/:id/associar-usuario', EmpresaController_1.EmpresaController.associateUsuario);
