 ...
 */
router.get('/', ImagemController_1.ImagemController.list);
/**
 * @swagger
 * /api/imagens/{id}:
 *   get:
 ...
 */
router.get('/:id', ImagemController_1.ImagemController.findById);
/**
 * @swagger
 * /api/imagens/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/ImagemResponse'
 */
router.put('/:id', ImagemController_1.ImagemController.update);
/**
 * @swagger
 * /api/imagens/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/MessageResponse'
 */
router.delete('/:id', ImagemController_1.ImagemController.remove);
exports.imagemRoutes = router;
//# sourceMappingURL=imagemRoutes.js.map